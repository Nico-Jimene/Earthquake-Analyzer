...
function stateName = findStateOfEQ( lat, long )
...
%  states: structure array that contains ALL the data about the states
%Returns:
%  state: an index b/n 1 and 50, e.g. index 27 is for NC
...
for i=1:length(states)
    distance = haversine( [lat, long] , [ states(i).CentroidLatitude, states(i).CentroidLongitude] );
...
stateName = states(stateIndex).name;
